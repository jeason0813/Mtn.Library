...
namespace Mtn.Library.Service
{
    ...
    {
        #region SortedHashContainer
        /// <summary>
        /// <para>Hash Container.</para>
        /// </summary>
        internal class SortedHashContainer : ContainerTemplate
        {
            private readonly SortedDictionary<string, CacheItem> _mCacheContainer = new SortedDictionary<string, CacheItem>(StringComparer.InvariantCultureIgnoreCase);
